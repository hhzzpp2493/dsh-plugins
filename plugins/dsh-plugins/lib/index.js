...
function resolveOptions(ctx, config) {
	...
	return {
		...
		// Search telemetry is intentionally not persisted as a session event.
		// Older/newer dsh builds may not know this plugin-specific event type,
		// and an unknown required event makes an otherwise usable session
		// impossible to reload after restart.
		recordRequest: () => {}
	};
}
